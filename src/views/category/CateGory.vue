<template>
  <div class="category">
    ...
    <scroll class="content">
      ...
      <tab-control :title="titleList" @tabClick="tabClick" ref="tabControl"/>
      <good-list :goodsItem="categoryDetailList"/>
    </scroll>
  </div>
</template>
...
<script>
  ...
  import SlideBar from "./childrenComps/SlideBar";
  ...
  export default {
    name: "CateGory",
    components: {GoodList, TabControl, Subcategory, SlideBar, Scroll, NavBar},
    data() {
      return {
        // 分类内容数据
        subcategoryList: [],
